#include "mbframe.h"
#define MB_READ_REQ_LEN (MBAP_HEADER_LEN+5)
...
int mb_build_read_holding(uint8_t *buf, size_t buflen, uint16_t tid,
    ...
    if (buf==NULL||buflen < MB_READ_REQ_LEN) {return -1;}
